...
def Model_DenseNet(Data, Target, sol):
    IMG_SIZE = [32, 32, 3]
    ...
    model.fit(Data, Target, steps_per_epoch=10, epochs=int(sol))
    pred = model.predict(Data)
    activation = activations.relu(Data).numpy()
...
#     activation, pred = Model_DenseNet(Images, Target)
#     np.save('Activation_DenseNet.npy', activation)
